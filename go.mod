...
require (
	...
	open-cluster-management.io/ocm v1.0.1-0.20250716024433-1a7baa6978db
...
replace github.com/openshift-online/maestro => github.com/morvencao/openshift-online-maestro v0.0.0-20250729034103-e0a9f04d3a88
